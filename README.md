...
--------
  ...
  * The server requires diamondd, leveldb and plyvel

  * The server code is open source. Anyone can run a server, removing
    single points of failure concerns.

  * The server knows which set of Diamond addresses belong to the same
...
------------
  ...
  2. To start and stop the server, use the 'electrum-dmd-server' script
